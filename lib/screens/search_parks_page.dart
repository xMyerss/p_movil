...
class SearchParksPage extends StatelessWidget {
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: const [
                          ...
                          SizedBox(height: 10),
                          Text('Ruta 1', style: TextStyle(fontSize: 14, color: Colors.black)),
                          Text('Ruta 2', style: TextStyle(fontSize: 14, color: Colors.black)),
                          Text('Ruta 3', style: TextStyle(fontSize: 14, color: Colors.black)),
                        ],
                      ),
                    ),
                  ),
